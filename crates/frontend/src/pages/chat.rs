...
#[component]
fn Thought(#[prop(into)] text: Signal<String>, forbid_media: bool) -> impl IntoView {
...
fn regeneration_parent_id(branch: &[crate::api::MessageNode]) -> Option<String> {
