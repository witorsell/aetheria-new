...
impl Default for ThemeTokens {
    fn default() -> Self {
        ThemeTokens {
            ...
            color_chat_bg: "transparent".into(),
            color_user_message_bg: "transparent".into(),
            color_assistant_message_bg: "transparent".into(),
            color_text_italic: "#7c5cff".into(),
            color_text_underline: "#ffffff".into(),
            color_shadow: "#000000".into(),
